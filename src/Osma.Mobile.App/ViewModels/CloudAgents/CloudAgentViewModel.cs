...
namespace Osma.Mobile.App.ViewModels.CloudAgents
{
    public class CloudAgentViewModel : ABaseViewModel
    {
                                       ...
                                       navigationService)
        {
            ...
            CloudAgentName = _record.Alias.Name;
            CloudAgentSubtitle = $"{_record.State:G}";
            CloudAgentImageUrl = _record.Alias.ImageUrl;
        }
        ...
        private string _cloudAgentImageUrl;
        public string CloudAgentImageUrl
        {
            get => _cloudAgentImageUrl;
            set => this.RaiseAndSetIfChanged(ref _cloudAgentImageUrl, value);
        }

        private string _cloudAgentSubtitle = "Lorem ipsum dolor sit amet";
        public string CloudAgentSubtitle
        {
            get => _cloudAgentSubtitle;
            set => this.RaiseAndSetIfChanged(ref _cloudAgentSubtitle, value);
        }
